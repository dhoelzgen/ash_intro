defmodule AshIntroWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {AshIntroWeb.Layouts, :root}
  ...
  scope "/", AshIntroWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {AshIntroWeb.LiveUserAuth, :live_user_required}
      #
  ...
  scope "/", AshIntroWeb do
    ...
    confirm_route AshIntro.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [AshIntroWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(AshIntro.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [AshIntroWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
