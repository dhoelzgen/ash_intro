defmodule AshIntro.Chat.Message.Changes.Respond do
  ...
  def change(changeset, _opts, context) do
    Ash.Changeset.before_transaction(changeset, fn changeset ->
      ...
      system_prompt =
        ...
        Your main tasks are about providing answers about events.
        The current date is #{Date.utc_today()}.
        """)
